...
import PreRegistrations from './PreRegistration'
    ...
    <div className='admin-screen-container'>
      <div className='admin-screen-left'>
        <div>
          ...
          <p onClick={() => setScreen('preRegistrations')}>Pre Registrations</p>
          <p onClick={() => setScreen('notify')}>Notify</p>
      ...
      <div className='admin-screen-right'>
        ...
        {screen === 'preRegistrations' && <PreRegistrations />}
